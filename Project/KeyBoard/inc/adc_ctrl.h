...
#define ROCK_CHANNEL			2
#define MINI_ROCK_CHANNEL		0

#define PUSH_ROD_CHANNEL		5
...
#define ADC_PORT_6				GPIOB




#define ADC_GET_TOTAL				6
...
#define BIG_ROCK_INTERVAL				(127 * 4)

#define BIG_ROCK_NEGATIVE_END			1460
#define BIG_ROCK_NEGATIVE_BEGIN			(BIG_ROCK_NEGATIVE_END + BIG_ROCK_INTERVAL)

#define BIG_ROCK_POSITIVE_END			2600
#define	BIG_ROCK_POSITIVE_BEGIN			(BIG_ROCK_POSITIVE_END - BIG_ROCK_INTERVAL)

#define BIG_ROCK_MAX_VALUE				127
#define BIG_ROCK_TIMES					(BIG_ROCK_INTERVAL / BIG_ROCK_MAX_VALUE)

#define ROCK_INTERVAL					(127 * 12)

#define ROCK_NEGATIVE_END				0xE80
#define ROCK_NEGATIVE_BEGIN				(ROCK_NEGATIVE_END - ROCK_INTERVAL)

#define ROCK_POSITIVE_END				0x180
#define	ROCK_POSITIVE_BEGIN				(ROCK_POSITIVE_END + ROCK_INTERVAL)

#define ROCK_MAX_VALUE					127
#define ROCK_TIMES						(ROCK_INTERVAL / 127)
